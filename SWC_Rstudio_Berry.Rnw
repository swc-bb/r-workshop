...
\begin{frame}[fragile]{Solution for scatterplot exercise}
...
\begin{frame}[fragile]{Solution for scatterplot exercise: Histogram}
...
\begin{frame}[fragile]{Solution for scatterplot exercise: Boxplot}
